...
function art_menu_xml_parcer($content, $show_sub_menus, $menu_class) {
  ...
  foreach($ul_elements as $ul_element) {
		// First ul element with css-class yellow-hmenu or yellow-vmenu
    if (($ul_element->getAttribute('class') == "yellow-vmenu") || ($ul_element->getAttribute('class') == "yellow-hmenu"))
		  break;
    continue;
  }
...
function art_content_replace($content) {
  ...
  $article_str = ' class="yellow-article"';
...
function art_get_sidebar($sidebar, $vnavigation, $class) {
  $result = 'yellow-layout-cell ';
  if (empty($sidebar) && empty($vnavigation)) {
    $result .= 'yellow-content';
  }
  else {
    $result .= $class;
  }
...
function art_get_content_cell_style($left, $vnav_left, $right, $vnav_right, $content) {
  return 'yellow-layout-cell yellow-content'; 
}
...
function art_vmenu_output($subject, $content) {
  ...
  $output =	art_menu_worker($content, true, 'yellow-vmenu');
  $bvm = "<div class=\"yellow-box yellow-vmenublock\">\r\n    <div class=\"yellow-box-body yellow-vmenublock-body\">\r\n";
  $bvmt = "<div class=\"yellow-bar yellow-vmenublockheader\">\r\n    <h3 class=\"t subject\">";
  $evmt = "</h3>\r\n</div>\r\n";
  $bvmc = "<div class=\"yellow-box yellow-vmenublockcontent\">\r\n    <div class=\"yellow-box-body yellow-vmenublockcontent-body\">\r\n<div class=\"content\">\r\n";
  $evmc = "\r\n</div>\r\n		<div class=\"cleared\"></div>\r\n    </div>\r\n</div>\r\n";
  $evm = "\r\n		<div class=\"cleared\"></div>\r\n    </div>\r\n</div>\r\n";
  echo $bvm;

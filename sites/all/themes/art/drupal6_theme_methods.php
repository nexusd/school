...
function art_menu_local_task($link, $active = FALSE) {
  $active_class = "";
  if ($active) {
    $active_class .= "active ";
  }
 ...
 *   A descriptive title of the feed.
  */
function art_feed_icon($url, $title) {
 ...
 */
function art_preprocess_comment_wrapper(&$vars) {
 ...
 */
function art_breadcrumb($breadcrumb) {
  if (!empty($breadcrumb)) {
    return '<div class="breadcrumb art-postcontent">'. implode(' | ', $breadcrumb) .'</div>';
  }
}

function art_service_links_node_format($links) {
...
*/
function art_img_assist_page($content, $attributes = NULL) {
 ...
 * @ingroup themeable
 */
function art_node_preview($node) {

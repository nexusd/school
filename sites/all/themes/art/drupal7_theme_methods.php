...
function art_process_html(&$variables) {
...
function art_breadcrumb($variables) {
 ...
 */
function art_preprocess_page(&$vars) {
 ...
 * @ingroup themeable
 */
function art_menu_local_task($variables) {
 ...
 */
function art_feed_icon($variables) {
 ...
 * @ingroup themeable
 */
function art_node_preview($variables) {
  $node = $variables['node'];

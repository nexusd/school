 ...
 * @ingroup themeable
 */
function nexus_menu_local_task($mid, $active, $primary) {
  $active_class = "";
  if ($active) {
    $active_class .= "active ";
  }
 ...
 */
function nexus_comment_wrapper($content, $type = null) {
  static $node_type;
...
function nexus_service_links_node_format($links) {
...
*/
function nexus_img_assist_page($content, $attributes = NULL) {
